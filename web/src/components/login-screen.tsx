...
export function LoginScreen({
  ...
  return (
    <div className="relative z-10 flex w-full flex-col items-center px-4 py-6 pb-[max(2rem,env(safe-area-inset-bottom))] sm:min-h-[100dvh] sm:justify-center sm:py-12">
