/**
 * Gravity stars background — from Animate UI (MIT), adapted for Vite:
 * https://animate-ui.com/docs/components/backgrounds/gravity-stars
 * Original credits: Brett Jackson / Framer marketplace.
 */
...
function GravityStarsBackground({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative h-full min-h-full w-full overflow-hidden bg-transparent text-teal-200/70",
        className,
      )}
      {...props}
    >
