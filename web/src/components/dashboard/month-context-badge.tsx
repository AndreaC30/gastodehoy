...
import { budgetReferenceDate, formatMonthYear } from "@/lib/month-context";
...
export function MonthContextBadge({ referenceDate }: Props) {
  ...
  const monthYear = formatMonthYear(ref, i18n.language);
  ...
  return (
    ...
    >
      <p className="text-base font-bold capitalize tracking-tight text-slate-100 sm:text-lg">
        {monthYear}
      </p>
